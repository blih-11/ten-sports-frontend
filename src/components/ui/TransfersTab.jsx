  ...
  return (
    ...
    >
      <div className="relative aspect-video overflow-hidden bg-gray-100">
        <CardThumb article={article} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" placeholderClass="w-full h-full bg-gradient-to-br from-gray-200 to-gray-100" />
